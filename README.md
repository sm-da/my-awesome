...
- [microsoft/Customer-Service-Conversational-Insights-with-Azure-OpenAI-Services](https://github.com/microsoft/Customer-Service-Conversational-Insights-with-Azure-OpenAI-Services) - A solution accelerator built on top of Azure Cognitive Search, Azure Speech and Azure OpenAI services that allows customers to quickly deploy an integrated platform and immediately extract actionable insights from customer conversations.
...
- [Anil-matcha/GPT-Auth](https://github.com/Anil-matcha/GPT-Auth) - GPT Auth provides a user-friendly solution to quickly setup oauth for your custom GPT and self-host it.
- [Asabeneh/30-Days-Of-React](https://github.com/Asabeneh/30-Days-Of-React) - 30 Days of  React challenge is a step by step guide to learn React in 30 days.  These videos may help too: https://www.youtube.com/channel/UC7PNRuno1rzYPb1xLa4yktw
- [Chalarangelo/30-seconds-of-code](https://github.com/Chalarangelo/30-seconds-of-code) - Short code snippets for all your development needs
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) - 🍰 Everything is RSSible
- [FnrDev/workers](https://github.com/FnrDev/workers) - Simple discord bot template using cloudflare workers
...
- [Mecanik/cloudflare-image-resizing-worker](https://github.com/Mecanik/cloudflare-image-resizing-worker) - Cloudflare Image Resizing worker for WordPress
...
- [SamurAIGPT/GPT-Agent](https://github.com/SamurAIGPT/GPT-Agent) - 🚀 Introducing 🐪 CAMEL: a game-changing role-playing approach for LLMs and auto-agents like BabyAGI & AutoGPT! Watch two agents 🤝 collaborate and solve tasks together, unlocking endless possibilities in #ConversationalAI, 🎮 gaming, 📚 education, and more! 🔥
...
- [supermario-ai/beautiful-lyrics](https://github.com/supermario-ai/beautiful-lyrics) - Completely revolutionizes the Spotify Lyrics Experience by introducing Live Lyrics, Dynamic Backgrounds, and Immersive Views
...
- [lewangdev/autotranslate](https://github.com/lewangdev/autotranslate) - Videos Transcription and Translation with Faster Whisper and ChatGPT
...
- [snakajima/SlashGPT](https://github.com/snakajima/SlashGPT) - 
...
- [IngestAI/deepmark](https://github.com/IngestAI/deepmark) - Deepmark AI enables a unique testing environment for language models (LLM) assessment on task-specific metrics and on your own data so your GenAI-powered solution has predictable and reliable performance.
...
- [BerriAI/reliableGPT](https://github.com/BerriAI/reliableGPT) - Get 100% uptime, reliability from OpenAI. Handle Rate Limit, Timeout, API, Keys Errors
...
- [Jibaku789/sd-webui-deepdanbooru-tag2folder](https://github.com/Jibaku789/sd-webui-deepdanbooru-tag2folder) - Using this script you can move images using deepdanbooru classification
...
- [MNeMoNiCuZ/sd-webui-thumbnailizer](https://github.com/MNeMoNiCuZ/sd-webui-thumbnailizer) - A thumbnail gallery / set management tool for Automatic1111 Webui
- [Mikubill/sd-webui-controlnet](https://github.com/Mikubill/sd-webui-controlnet) - WebUI extension for ControlNet
- [MrEdwards007/WhisperTaskAcceleration](https://github.com/MrEdwards007/WhisperTaskAcceleration) - Accelerate Whisper tasks such as transcription, by multiprocesing through parallelization
...
- [cocktailpeanut/ComfyUI](https://github.com/cocktailpeanut/ComfyUI) - A powerful and modular stable diffusion GUI with a graph/nodes interface.
...
- [gh18l/CrawlGPT](https://github.com/gh18l/CrawlGPT) - 
...
- [mix1009/model-keyword](https://github.com/mix1009/model-keyword) - Automatic1111 WEBUI extension to autofill keyword for custom stable diffusion models and LORA models.
...
- [nimadez/mental-diffusion](https://github.com/nimadez/mental-diffusion) - Stable diffusion command-line interface
- [nlpxucan/WizardLM](https://github.com/nlpxucan/WizardLM) - LLMs build upon Evol Insturct: WizardLM, WizardCoder, WizardMath
- [omniinfer/sd-webui-cloud-inference](https://github.com/omniinfer/sd-webui-cloud-inference) - Stable Diffusion（SDXL/Refiner）WebUI Cloud Inference Extension
...
- [papuSpartan/stable-diffusion-webui-distributed](https://github.com/papuSpartan/stable-diffusion-webui-distributed) - Chains stable-diffusion-webui instances together to facilitate faster image generation.
...
- [srwi/MockSign](https://github.com/srwi/MockSign) - Easily simulate printing, hand-signing and scanning of documents, inspired by FalsiSign: https://gitlab.com/edouardklein/falsisign
...
- [discourse/discourse-ai](https://github.com/discourse/discourse-ai) - 
...
- [frntn/devcontainers-features](https://github.com/frntn/devcontainers-features) - 
...
- [kurtosis-tech/autogpt-package](https://github.com/kurtosis-tech/autogpt-package) - It's like Auto-GPT met Brew. The easiest and fastest way to get started with AutoGPT with any backend of your choice & whatever plugins you may need
...
- [DahnM20/ai-flow](https://github.com/DahnM20/ai-flow) - Open-source tool designed to seamlessly connect multiple AI model APIs in a repeatable flow.
...
- [JonnyBurger/website-scroller](https://github.com/JonnyBurger/website-scroller) - 
...
- [Skye-31/workers-ai-bot](https://github.com/Skye-31/workers-ai-bot) - A discord bot using Cloudflare Workers AI to do image generation based on text prompts
...
- [ahaapple/GPTS-Crawler-Dataset](https://github.com/ahaapple/GPTS-Crawler-Dataset) - 10000+ awesome gpts store and gpts crawler
...
- [dzhng/llamaflow](https://github.com/dzhng/llamaflow) - The Typescript-first prompt engineering toolkit for working with chat based LLMs.
...
- [exa-labs/exa-js](https://github.com/exa-labs/exa-js) - 
...
- [rabbit-hole-syndrome/open-source-embeddings](https://github.com/rabbit-hole-syndrome/open-source-embeddings) - Source code for "$0 Embeddings (OpenAI vs. free & open source)" 🎥
...
- [supermario-ai/playwright](https://github.com/supermario-ai/playwright) - Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API. 
- [tiangolo/full-stack-fastapi-postgresql](https://github.com/tiangolo/full-stack-fastapi-postgresql) - Full stack, modern web application generator. Using FastAPI, PostgreSQL as database, Docker, automatic HTTPS and more.
- [tldraw/make-real-starter](https://github.com/tldraw/make-real-starter) - Make it real
- [uriva/rmmbr](https://github.com/uriva/rmmbr) - Cache stuff easily, locally or in the cloud.
...
- [Anil-matcha/Free-GPT-Actions](https://github.com/Anil-matcha/Free-GPT-Actions) - A listing of Free GPT actions available for public use
...
- [FlowiseAI/FlowiseDocs](https://github.com/FlowiseAI/FlowiseDocs) - Docs for Flowise
- [GreenDeploy-io/oauth-gpt](https://github.com/GreenDeploy-io/oauth-gpt) - Resources and howto for making oauth for your custom gpt in OpenAI's GPT Builder
...
- [RadientBrain/PDFs-Popular-Libraries-Documentations](https://github.com/RadientBrain/PDFs-Popular-Libraries-Documentations) - 
- [abilzerian/LLM-Prompt-Library](https://github.com/abilzerian/LLM-Prompt-Library) - Advanced Code and Text Manipulation Prompts for Various LLMs. Suitable for GPT-4, Claude, Llama2, Falcon, Bard, and other high-performing open-source LLMs.
...
- [mikhail-bot/stable-diffusion-negative-prompts](https://github.com/mikhail-bot/stable-diffusion-negative-prompts) - A list of solid negative prompts for stable diffusion
...
- [yzfly/Awesome-Multimodal-Prompts](https://github.com/yzfly/Awesome-Multimodal-Prompts) -  Prompts of GPT-4V & DALL-E3 to full utilize the multi-modal ability. GPT4V Prompts, DALL-E3 Prompts.
